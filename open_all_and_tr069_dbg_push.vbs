...
Function OpenTelnet()
	...
	WScript.Sleep 500
	oShell.SendKeys"cd /data"
	oShell.SendKeys("{Enter}")
	
	WScript.Sleep 500
	oShell.SendKeys"touch cwmpc_stub"
	oShell.SendKeys("{Enter}")
	...
	WScript.Sleep 500
	oShell.SendKeys"cd /usr/sbin/"
	oShell.SendKeys("{Enter}")
	
	WScript.Sleep 500
	oShell.SendKeys"tftp -g "+srcIp+" -r cwmpc_start.sh"
	oShell.SendKeys("{Enter}")

	WScript.Sleep 500
	oShell.SendKeys"chmod 777 cwmpc_start.sh"
	oShell.SendKeys("{Enter}")
	
	WScript.Sleep 500
	oShell.SendKeys"mount -o remount,ro /"
	oShell.SendKeys("{Enter}")
	
	WScript.Sleep 500
	oShell.SendKeys"lc_nm cwmpcd restart"
	oShell.SendKeys("{Enter}")	
	
	WScript.Sleep 500
	oShell.SendKeys"tail -f /data/cwmpc.log"
	oShell.SendKeys("{Enter}")	
End Function
